...
void loop()
{
  ...
  printSensorDataOnSerial();
  delay(1000);
}


void printSensorDataOnSerial(){
  Serial.print("\nAcelerometro: X: ");
  Serial.print(acelerometro.getX());
  Serial.print(" Y: ");
  Serial.print(acelerometro.getY());
  Serial.print(" Z: ");
  Serial.print(acelerometro.getZ());
  
  Serial.print("\nGiroscopio: X: ");
  Serial.print(giroscopio.getX());
  Serial.print(" Y: ");
  Serial.print(giroscopio.getY());
  Serial.print(" Z: ");
  Serial.println(giroscopio.getZ());
